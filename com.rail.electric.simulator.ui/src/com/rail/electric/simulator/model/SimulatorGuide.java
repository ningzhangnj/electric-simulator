...
public class SimulatorGuide implements Serializable {
	 ...
	 *            a vertical ruler)
	 */
	public SimulatorGuide(boolean isHorizontal) {
	 ...
	 */
	public void attachPart(SimulatorSubpart part, int alignment) {
		if (getMap().containsKey(part) && getAlignment(part) == alignment)
			return;

		getMap().put(part, new Integer(alignment));
		SimulatorGuide parent = isHorizontal() ? part.getHorizontalGuide() : part
				.getVerticalGuide();
	 ...
	 */
	public void detachPart(SimulatorSubpart part) {
	 ...
	 * {@link org.eclipse.gef.SimulatorXYLayoutEditPolicy.logicdesigner.edit.LogicXYLayoutEditPolicy
	 ...
	 * @see org.eclipse.gef.SimulatorXYLayoutEditPolicy.logicdesigner.edit.LogicXYLayoutEditPolicy#createChangeConstraintCommand(ChangeBoundsRequest,
	 *      EditPart, Object)
	 */
	public int getAlignment(SimulatorSubpart part) {
