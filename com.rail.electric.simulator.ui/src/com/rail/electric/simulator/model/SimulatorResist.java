...
public class SimulatorResist extends SimulatorSubpart {
	...
	private static Image LOGIC_RESIST_ICON = createImage(LED.class,
			"icons/resist16.gif"); //$NON-NLS-1$

	private static int count;

	public SimulatorResist() {
		super();
