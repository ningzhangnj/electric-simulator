...
public class DimensionPropertySource implements IPropertySource {
	...
	static {
		PropertyDescriptor widthProp = new TextPropertyDescriptor(ID_WIDTH,
				SimulatorMessages.DimensionPropertySource_Property_Width_Label);
		widthProp.setValidator(SimulatorNumberCellEditorValidator.instance());
		PropertyDescriptor heightProp = new TextPropertyDescriptor(ID_HEIGHT,
				SimulatorMessages.DimensionPropertySource_Property_Height_Label);
		heightProp.setValidator(SimulatorNumberCellEditorValidator.instance());
