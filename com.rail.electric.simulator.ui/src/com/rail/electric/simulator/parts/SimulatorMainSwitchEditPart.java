...
import com.rail.electric.simulator.policies.SimulatorMainSwitchEditPolicy;

public class SimulatorMainSwitchEditPart extends SimulatorEditPart {
	...
	protected void createEditPolicies() {
		...
		installEditPolicy(EditPolicy.COMPONENT_ROLE, new SimulatorMainSwitchEditPolicy());
	}

	protected IFigure createFigure() {
		MainSwitchFigure resist = new MainSwitchFigure();
		return resist;		
	}
