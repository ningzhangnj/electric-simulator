 ...
 */
public class SimulatorDiagramEditPart extends SimulatorContainerEditPart implements
		LayerConstants {

	protected AccessibleEditPart createAccessible() {
		return new AccessibleGraphicalEditPart() {
			public void getName(AccessibleEvent e) {
				e.result = SimulatorMessages.SimulatorDiagram_LabelText;
			}
		};
	}
	...
	protected void createEditPolicies() {
		...
		installEditPolicy(EditPolicy.LAYOUT_ROLE, new SimulatorXYLayoutEditPolicy(
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if (SimulatorDiagram.ID_ROUTER.equals(evt.getPropertyName()))
			refreshVisuals();
		else
	...
	protected void refreshVisuals() {
		...
		if (getSimulatorDiagram().getConnectionRouter().equals(
				SimulatorDiagram.ROUTER_MANUAL)) {
			AutomaticRouter router = new FanRouter();
			router.setNextRouter(new BendpointConnectionRouter());
			cLayer.setConnectionRouter(router);
		} else if (getSimulatorDiagram().getConnectionRouter().equals(
				SimulatorDiagram.ROUTER_MANHATTAN))
