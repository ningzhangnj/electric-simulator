...
import com.rail.electric.simulator.policies.SimulatorSwitchEditPolicy;

public class SimulatorSwitchEditPart extends SimulatorEditPart {
	...
	protected void createEditPolicies() {
		...
		installEditPolicy(EditPolicy.COMPONENT_ROLE, new SimulatorSwitchEditPolicy());
	}

	protected IFigure createFigure() {
		SwitchFigure resist = new SwitchFigure();
		return resist;		
	}
