...
public class LEDFigure extends NodeFigure implements HandleBounds {
	...
	protected void paintFigure(Graphics g) {
		...
		g.setBackgroundColor(SimulatorColorConstants.logicGreen);
		g.setForegroundColor(SimulatorColorConstants.connectorGreen);
		...
		// Draw the connectors
		g.setForegroundColor(SimulatorColorConstants.connectorGreen);
		g.setBackgroundColor(SimulatorColorConstants.connectorGreen);
		for (int i = 0; i < 4; i++) {
		...
		// Draw the display
		g.setBackgroundColor(SimulatorColorConstants.logicHighlight);
